...
export const techStack: TechStack[] = [
  ...
  { name: 'Cursor AI', shortName: 'CR', color: 'bg-blue-500', logo: '/tech-logos/cursor.svg' },
  ...
  { name: 'MCP', shortName: 'MCP', color: 'bg-teal-600', logo: '/tech-logos/mcp.svg' },
  ...
  { name: 'Microsoft Fabric', shortName: 'MF', color: 'bg-indigo-700', logo: '/tech-logos/fabric.svg' },
];
