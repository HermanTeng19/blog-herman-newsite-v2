        ...
        <div className="space-y-6">
          ...
          <div className="social-links-container">
            <div className="social-icons-grid">
              <a 
                href="https://resume.hermanteng.net" 
                target="_blank" 
                rel="noopener noreferrer"
                className="social-icon-link"
                aria-label="Resume Website"
              >
                <div className="social-icon resume-icon">
              ...
              <a 
                href="https://www.linkedin.com/in/hermanteng" 
                target="_blank" 
                rel="noopener noreferrer"
                className="social-icon-link"
              ...
              <a 
                href="https://github.com/HermanTeng19" 
                target="_blank" 
                rel="noopener noreferrer"
                className="social-icon-link"
              ...
              <a 
                href="mailto:herman.teng@outlook.com" 
                className="social-icon-link"
